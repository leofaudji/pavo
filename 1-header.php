...
<html lang="en">
    <head>
        ...
        <!-- SEO Meta Tags -->
        <meta name="description" content="Lintasan - Software Cloud & Aplikasi SaaS untuk Koperasi di Indonesia" />
        <meta name="author" content="lintasan" />

        <!-- OG Meta Tags to improve the way the post looks when you share the page on Facebook, Twitter, LinkedIn -->
        <meta property="og:site_name" content="lintasan" />
        <meta property="og:site" content="https://lintasan.com" />
        <meta property="og:title" content="Lintasan - Software Cloud & Aplikasi SaaS untuk Koperasi di Indonesia" />
        ...
        <meta property="og:url" content="https://lintasan.com" /> 
        <meta name="twitter:card" content="summary_large_image" /> 

        <!-- Webpage Title -->
        <title>Lintasan - Software Cloud & Aplikasi SaaS untuk Koperasi di Indonesia</title>
        ...
        <nav class="navbar fixed-top">
            <div class="container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
                ...
                <a class="inline-block mr-4 py-0.5 text-xl whitespace-nowrap hover:no-underline focus:no-underline" href="./">
                    <img src="images/logo.png" alt="alternative" class="h-12" />
                </a>
                    ...
                    <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdown01">
                                <a class="dropdown-item page-scroll" href="./article.php">Article Details</a> 
