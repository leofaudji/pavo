...
<!-- Header -->
        ...
        <div id="features" class="cards-1">
            <div class="container px-4 sm:px-8 xl:px-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Lengkap dan Integrasi</h5>
                        <p class="mb-4">Peningkatan produktivitas dan performa bisnis melalui solusi yang modern dan terintegrasi.</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-4">User interface dan Experience yang friendly.</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Performa handal</h5> 
                        <p class="mb-4">Kode yang dioptimalkan memastikan tidak ada delay dan respon yang cepat.</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Dukungan yang terpercaya</h5>
                        <p class="mb-4">Kemudahan dan kenyamanan layanan purna jual terbaik.</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Custom by request</h5>
                        <p class="mb-4">Custom request sesuai dengan permintaan anda.</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Support kapanpun</h5>
                        <p class="mb-4">Melayani support 24 Jam sepanjang hari.</p> 
                    </div>
                </div>
                <!-- end of card -->
            ...
            <div class="container px-4 pb-px sm:px-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list mb-7 space-y-2 text-left">
                            ...
                            <li class="flex">
                                <i class="fas fa-chevron-right"></i>
                                <div>Laporan Mutasi Simpanan</div>
                            </li>
                            <li class="flex">
                                <i class="fas fa-chevron-right"></i>
                                <div>Laporan Mutasi Pinjaman</div>
                            </li>
                            <li class="flex">
                                <i class="fas fa-chevron-right"></i>
                                <div>Laporan Saldo Simpanan</div>
                            </li>
                            <li class="flex">
                                <i class="fas fa-chevron-right"></i>
                                <div>Laporan Saldo Pinjaman</div>
                            </li>
                        </ul>
                        <div class="button-wrapper">
                            <a class="btn-solid-reg" href="#pilihpaket">Coba gratis</a>
                        </div>
                    </div>
                </div> <!-- end of card -->
                <!-- end of card -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="button-wrapper">
                            <a class="btn-solid-reg page-scroll" href="#pilihpaket">Pilih paket</a>
                        </div>
                    </div>
                </div> <!-- end of card -->
                <!-- end of card -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list mb-7 text-left space-y-2">
                            ...
                            <li class="flex">
                                <i class="fas fa-chevron-right"></i>
                                <div>Laporan Grafik Pertumbuhan Simpanan/Pinjaman</div>
                            </li>
                            <li class="flex">
                                <i class="fas fa-chevron-right"></i>
                                <div>Laporan Grafik Pertumbuhan Neraca & L/R</div>
                            </li>
                            <li class="flex">
                                <i class="fas fa-chevron-right"></i>
                                <div>dan lainnya custom by request...</div>
                            </li>
                        </ul>
                        <div class="button-wrapper">
                            <a class="btn-solid-reg page-scroll" href="#pilihpaket">Pilih paket</a>
        ...
        <!-- Conclusion -->
        <div id="demogratis" class="basic-5">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2">
                ...
                <div class="lg:mt-24 xl:mt-44 xl:ml-12">
                    ...
                    <p class="mb-4 text-gray-800 text-1xl leading-1">
                        ...
                        Untuk meningkatkan produktivitas dan performa bisnis melalui solusi yang modern dan terintegrasi.
                    </p>
                    <a class="btn-solid-lg secondary" href="#your-link"><i class="fab fa-google-play"></i>Demo Gratis</a>
                </div>
            </div> <!-- end of container -->
